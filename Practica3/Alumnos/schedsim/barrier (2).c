...
int sys_barrier_wait(sys_barrier_t *barrier)
{
    ...
    */
    ...
    ++(barrier->nr_threads_arrived);  //incrementar el numero de CPUS
    if(barrier->nr_threads_arrived >= barrier->max_threads){  //si llegan todas
      barrier->nr_threads_arrived = 0;  //se inicializa el contador de CPUs
